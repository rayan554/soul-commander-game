...
handleMobileScroll() {
    ...
    if (scrollY > 50) {
        ...
        if (header) header.style.boxShadow = '0 2px 10px rgba(0, 0, 0, 0.3)';
        if (footer) footer.style.boxShadow = '0 -2px 10px rgba(0, 0, 0, 0.3)';
    } else {
        if (header) header.style.boxShadow = '';
        if (footer) footer.style.boxShadow = '';
    }
}
{
    constructor() {
    ...
    // Setup mobile scrolling - TAMBAHAN BARU
